...
router.post(
  ...
  [
    ...
    body('objet')
      ...
      .isLength({ max: 100 }).withMessage('L\'objet ne doit pas dépasser 100 caractères'),
    body('raison')
      .trim()
      .notEmpty().withMessage('La raison est requise')
      .isIn(['produit', 'service', 'livraison', 'facturation', 'autre']).withMessage('Raison invalide'),
    body('description')
      .trim()
...
router.put(
  ...
  [
    ...
    body('statut')
      ...
      .isIn(['nouveau', 'en_cours', 'resolu', 'fermer']).withMessage('Statut invalide')
  ],
  validate,
